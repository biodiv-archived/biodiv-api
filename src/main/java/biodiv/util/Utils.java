...
public class Utils {
    ...
    private static String buildURL(HttpServletRequest request, String pathInfo, Map<String, String> parameters,
                                   boolean includeContextPath) throws URISyntaxException {
    ...
    private static String cleanSciName(String sciName) {
        ...
        if (cleanSciName.indexOf(" ") == -1) {
            cleanSciName =
                    cleanSciName.toLowerCase().substring(0, 1).toUpperCase() + cleanSciName.toLowerCase().substring(1);
        } else {
    ...
    public static Response toJSONResponse(String message) {
